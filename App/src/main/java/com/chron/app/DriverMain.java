...
public class DriverMain extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_driver_main);
        View chips = (EditText) findViewById(R.id.startpoint);
        Bitmap bkg = ((BitmapDrawable) getResources().getDrawable(R.drawable.input)).getBitmap();
        BitmapDrawable bkgbt = new BitmapDrawable(getResources(),bkg);
        chips.setBackgroundDrawable((Drawable) bkgbt);

        View chips1 = (EditText) findViewById(R.id.endpoint);
        Bitmap bkg1 = ((BitmapDrawable) getResources().getDrawable(R.drawable.input)).getBitmap();
